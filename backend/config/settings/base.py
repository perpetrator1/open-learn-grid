"""
Base Django settings for Open Learn Grid project.

All environment-specific settings should inherit from this.
"""
...
DATABASES = {
    'default': {
        ...
        'NAME': config('POSTGRES_DB', default='openlearngrid'),
...
# Defaults to local filesystem; overridden in production for S3
...
SIMPLE_JWT = {
    ...
    'ALGORITHM': 'HS256',
    'SIGNING_KEY': None,  # Overridden per environment
    'VERIFYING_KEY': None,
    'AUDIENCE': None,
    'ISSUER': None,
    'JTI_CLAIM': 'jti',
